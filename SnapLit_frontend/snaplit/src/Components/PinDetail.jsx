...
import {Link, link, useParams, useparams} from 'react-router-dom';
import {v4 as uuidv4} from 'uuid';

import { client, urlFor } from '../client';
import MasonryLayout from './MasonryLayout';
import {PinDatailMorePinQuery, pinDetailMorePinQuery, pinDetailQuery} from '../utils/data';
...
<Link to={`user-profile/${pinDetail.postedBy?._id}`} className='flex gap-2 mt-5 items-center bg-white rounded-lg'>
     ...
     <p className='font-semi-bold capitalize'>{pinDetail.postedBy?.name}</p>
</Link>
